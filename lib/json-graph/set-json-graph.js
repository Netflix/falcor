module.exports = set_json_graphs_as_jsong;
...
function set_json_graphs_as_jsong(model, envelopes, values) {
    ...
    values && (values[0] = roots.json !== undefined && { jsong: roots.json, paths: roots.r } || undefined);
...
var values  = set_json_graphs_as_jsong(model, envelopes, [{}]);
