...
module.exports = function walkPath(model, root, curr, path, depth, seed,
    ...
    var key = keySet;
    var allowEnumerableJSONResponses = model._allowEnumerableJSONResponses;
    var fromWhenceYouCame = model._fromWhenceYouCame;
    if (isKeySet) {
        iteratorNote = {};
    ...
    do {
        ...
        if (next) {
            ...
            if (next) {
                ...
                if (referenceContainer && fromWhenceYouCame) {
                    obj = {
                ...
                // contain references.
                else if (allowEnumerableJSONResponses) {
                    obj = {
                        $__path: next.$absolutePath
                    }
                }
                    ...
                    obj = {};
                    Object.defineProperty(obj, '$__path', schema);
                    obj.$__path = next.$absolutePath
                }
