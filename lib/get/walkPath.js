...
var spec = {};
spec.$path = hiddenSpec;
spec.$refPath = hiddenSpec;

var proto = Object.create(null, spec);
...
module.exports = function walkPath(model, root, curr, path, depth, seed,
    ...
    do {
        ...
        if (next) {
            ...
            if (next) {
                var obj;
                if (model._allowEnumerableMetadata) {
                    obj = {};
                }
                else {
                ...
                obj.$path = next.$absolutePath;
                if (fromReference) {
                    obj.$refPath = next.$absolutePath;
                }
