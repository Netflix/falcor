...
var onValueType = require("./onValue");
...
module.exports = function walkJSON(model, root, curr, json,
                  depthArg, seed, outerResults, optimizedPath,
                  requestedPath, isJSONG,
                  fromReferenceArg) {
    ...
    do {
        ...
        getWalk(model, root, next, json, nextDepth, seed, outerResults,
                optimizedPath, requestedPath, isJSONG, fromReference);
