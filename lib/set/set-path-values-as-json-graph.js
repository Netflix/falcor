module.exports = set_path_values_as_json_graph;
...
function set_path_values_as_json_graph(model, pathvalues, values, error_selector) {
    ...
    json.paths || (json.paths = roots.requestedPaths);
