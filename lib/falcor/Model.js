...
var getGenerationSync = require('./../get/getGenerationSync');
...
Model.prototype = {
    ...
    getGenerationSync: function(path) {
        path = pathSyntax.fromPath(path);
        ...
        this.syncCheck("getValueSync");
        return this._getGenerationSync(this, path);
    },
    _getGenerationSync: getGenerationSync,
