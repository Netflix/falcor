...
function Model(o) {
    ...
    this._allowEnumerableMetadata = options.allowEnumerableMetadata ||
        options._allowEnumerableMetadata || false;
...
/**
 * Do you want an instantaneous performance improvement of falcor?  Then turn this
 * on for a 3x improvement in node!!!
 * @private
 */
Model.prototype._enumerateMetadata = function allowEnumerableMetadata(allow) {
    return this._clone({
        _allowEnumerableMetadata: allow
    });
};
 ...
 * @private
 */
Model.prototype._fromWhenceYouCame = function allowFromWhenceYouCame(allow) {
    return this._clone({
        _allowFromWhenceYouCame: allow
    });
};
