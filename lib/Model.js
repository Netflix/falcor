...
Model.prototype.get = function get() {
    validateInput(arguments, GET_VALID_INPUT, 'get');
...
Model.prototype.set = function set() {
    validateInput(arguments, SET_VALID_INPUT, 'set');
    return this._set.apply(this, arguments);
};

Model.prototype.preload = function preload() {
    validateInput(arguments, GET_VALID_INPUT, 'preload');
...
Model.prototype.getValue = function getValue(path) {
    validateInput([path], VALUE_VALID_INPUT, 'getValue');
    return this._get(path, identity);
};

Model.prototype.setValue = function setValue(pathArg, valueArg) {
    validateInput(pathArg, VALUE_VALID_INPUT, 'setValue');
