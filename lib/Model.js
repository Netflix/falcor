...
function Model(o) {
    ...
    this.data = Object.defineProperty(this, "data", {
        get: function() {
            if (!this._schema) {
                throw new Error("Need schema to be defined to access .data");
            }
            if (this._data) {
                return this._data;
            }
...
Model.prototype.generateAPI = function(schema, prefixPath) {
    ...
    function enhanceObj(obj, objPath) {
        ...
        obj.then = function(cb) {
            return model.getValue(objPath).then(cb);
        };
        obj.subscribe = function(onSuccess, onError, onComplete) {
            return model.getValue(objPath).subscribe(onSuccess, onError, onComplete);
        };
        return obj;
    }
    if (schema.$type === "ref") {
