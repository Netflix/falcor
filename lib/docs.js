...
/**
 * Get the {@link Model}'s local cache as a {@link JSONGraph value}. This method can be a useful when storing state to 
 * local storage. This method accepts {@link PathSet}s to retrieve from the {@link Model} cache. If no paths are specified, 
 * the entire cache is returned.
 * @name getCache
 * @function
 * @arg {...Array.<PathSet>} pathSets the path(s) to retrieve
 * @returns {JSONGraph} jsonGraph a JSONGraph object to use as the local cache.
 * @memberof Model.prototype
 * @example
