...
/**
 * Returns a copy of the {@link Model} that unboxes treats errors as values. This means that the {@link Model} will report 
 * errors in the same callback used to report data. Errors will appear as objects in responses, rather than being sent to 
 * the {@link Observable~onErrorCallback} callback of the {@link ModelResponse}.
 * @name treatErrorsAsValues
 * @memberof Model.prototype
 * @function
