...
var model = 
    new falcor.
        ...
        // Always return the JSON Graph Atoms objects (ref, sentinel, error) because we want to serialize them
        boxValues().
        // Add errors to the message instead of sending them to the error callback
        treatErrorsAsValues().
        // Explicitly create a {$type:'sentinel'} object for every value not found in the cache
 ...
 * @example
//TODO: atom <-> sentinel ?  $expires value wtf?
var model = new falcor.Model();
model.setCache({
    user: {
        name: {
