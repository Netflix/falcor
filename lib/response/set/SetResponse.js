...
var SetResponse = module.exports = function SetResponse(model, args,
    ...
    this._value = [{}];
    this._isMaster = model._source === undefined;
...
SetResponse.prototype = Object.create(Observable.prototype);
...
SetResponse.prototype._subscribe = function _subscribe(observer) {
    ...
    return setRequestCycle(
        model, observer, requestedPaths, optimizedPaths,
        isJSONGraph, isProgressive, 0);
};
...
SetResponse.prototype.subscribe = ModelResponse.prototype.subscribe;
SetResponse.prototype.then = ModelResponse.prototype.then;
