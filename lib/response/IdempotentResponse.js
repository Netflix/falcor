...
IdempotentResponse.prototype = Object.create(ModelResponse.prototype);
...
IdempotentResponse.prototype.ensureCollect = function ensureCollect(model, initialVersion, pendingPromiseID) {
    ...
    var ensured = this["finally"](function ensureCollect() {
        ...
        var collectionScheduler = modelRoot.collectionScheduler;
        var pendingPromises = modelRoot.pendingPromises;
        collectionScheduler.schedule(function collectThisPass() {
            if(!Boolean(pendingPromises[pendingPromiseID])) {
                collect_lru(modelRoot, modelRoot.expired, get_size(modelCache), model._maxSize, model._collectRatio);
            } else {
                pendingPromises[pendingPromiseID] = collectThisPass;
            }
        });
    });
