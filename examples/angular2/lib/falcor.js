...
!function(e) {
  if ("object" == typeof exports)
    ...
    System.register("falcor", [], false, typeof e == "function" ? e : function() {
      return e;
    });
  else {
    var f;
    "undefined" != typeof window ? f = window : "undefined" != typeof global ? f = global : "undefined" != typeof self && (f = self), f.falcor = e();
  }
}(function() {
  var define,
      module,
  ...
  return (function e(t, n, r) {
    ...
    3: [function(_dereq_, module, exports) {
      ...
      Model.prototype = {
        ...
        getValue: function(path) {
          return this.get(path, function(x) {
            return x;
          });
        },
        ...
        bind: function(boundPath) {
          ...
          return falcor.Observable.create(function(observer) {
            ...
            try {
              ...
              }).concat(function() {})).subscribe(function onNext() {}, function onError(err) {
      ...
      "./operations": 11,
      "./operations/call": 6,
      "./operations/parser/parser": 16,
      "./request/RequestQueue": 40,
      "./scheduler/ImmediateScheduler": 42,
      "./scheduler/TimeoutScheduler": 43
    }],
          ...
          var disposable = model.getValue(path).flatMap(function(localFn) {
            if (typeof localFn === "function") {
              return falcor.Observable.return(localFn.apply(rootModel.bindSync(thisPath), args).map(function(pathValue) {
                ...
                return rootModel.get.apply(rootModel, envelope.paths.reduce(function(paths, path) {
    ...
    7: [function(_dereq_, module, exports) {
      ...
      module.exports = function getInitialArgs(options, seeds, onNext) {
        ...
        var operations = combineOperations(options.operationArgs, options.format, 'get', spreadOperations, isProgressive);
        setSeedsOrOnNext(operations, seedRequired, seeds, onNext, options.operationSelector);
        var requestOptions;
        return [operations];
      };
    }, {
      "./../support/combineOperations": 26,
      "./../support/setSeedsOrOnNext": 39
    }],
    8: [function(_dereq_, module, exports) {
      ...
      function getSourceRequest(options, onNext, seeds, combinedResults, requestOptions, cb) {
        ...
        return model._request.get(missingPaths, combinedResults.optimizedMissingPaths, getSourceObserver(model, missingPaths, function getSourceCallback(err, results) {
          if (err) {
            cb(err);
            return ;
          }
          var partitionOperationsAndSeeds = partitionOperations(results, seeds, options.format, onNext);
          cb(null, partitionOperationsAndSeeds);
        }));
      }
    }, {
      "./../support/getSourceObserever": 27,
      "./../support/mergeBoundPath": 31,
      "./../support/partitionOperations": 34
    }],
    9: [function(_dereq_, module, exports) {
      ...
      var get = request(getInitialArgs, getSourceRequest, processOperations, shouldRequest);
      module.exports = get;
    }, {
      "./../request": 18,
      "./../support/processOperations": 36,
      "./getInitialArgs": 7,
      "./getSourceRequest": 8,
      "./shouldRequest": 10
    }],
    ...
    11: [function(_dereq_, module, exports) {
      ...
      module.exports = function modelOperation(name) {
        return function() {
          ...
          return ModelResponse.fromOperation(model, args, selector, modelResponder);
        };
      };
    }, {
      "../ModelResponse": 4,
    ...
    12: [function(_dereq_, module, exports) {
      ...
      var request = _dereq_('./../request');
      var processOperations = _dereq_('./../support/processOperations');
      var invalidate = request(invalidateInitialArgs, null, processOperations);
      module.exports = invalidate;
    }, {
      "./../request": 18,
      "./../support/processOperations": 36,
      "./invalidateInitialArgs": 13
    }],
    13: [function(_dereq_, module, exports) {
      ...
      module.exports = function getInitialArgs(options, seeds, onNext) {
        var seedRequired = options.format !== 'AsValues';
        var operations = combineOperations(options.operationArgs, options.format, 'inv');
        setSeedsOrOnNext(operations, seedRequired, seeds, onNext, options.operationSelector);
    ...
    16: [function(_dereq_, module, exports) {
      ...
      function closeIndexer(token, state, out) {
        ...
        cleanIndexerTokenState(state);
        state.indexer = state.inIndexer = undefined;
      }
      ...
      function cleanIndexerRangeState(state) {
        state.inclusiveRange = state.exclusiveRange = state.range = state.rangeCloseToken = state.rangeCount = undefined;
      }
      function cleanIndexerTokenState(state) {
        state.indexerToken = state.indexerTokenQuoted = undefined;
      }
      ...
      module.exports = function tokenizer(string) {
        ...
        return function() {
          ...
          do {
            ...
            var isQuote = character === SINGE_OUOTES || character === DOUBLE_OUOTES;
            if (character !== undefined && SPECIAL_CHARACTERS.indexOf(character) === -1) {
              token += character;
              ++idx;
              continue;
            }
    ...
    18: [function(_dereq_, module, exports) {
      ...
      function request(initialArgs, sourceRequest, processOperations, shouldRequestFn) {
        ...
        return function innerRequest(options) {
          ...
          var errors = [];
          var format = options.format = selector && 'AsJSON' || options.format || 'AsPathMap';
          ...
          function recurse(operations, opts) {
            ...
            var combinedResults = processOperations(model, operations, errorSelector, opts);
            ...
            if (shouldRequestFn(model, combinedResults, loopCount)) {
              sourceRequest(options, onNext, seeds, combinedResults, opts, function onCompleteFromSourceSet(err, results) {
                if (err) {
          ...
          try {
            recurse.apply(null, initialArgs(options, seeds, onNext));
          } catch (e) {
            errors = [e];
            onCompletedOrError(onCompleted, onError, errors);
          }
      ...
      "./parser/parser": 16,
      "./support/onCompletedOrError": 32,
      "./support/onNextValue": 33,
      "./support/primeSeeds": 35,
      "./support/setSeedsOrOnNext": 39
    }],
    19: [function(_dereq_, module, exports) {
      ...
      var shouldRequest = _dereq_('./shouldRequest');
      var set = request(setInitialArgs, setSourceRequest, setProcessOperations, shouldRequest);
      module.exports = set;
    }, {
      "./../request": 18,
      "./setInitialArgs": 20,
      "./setProcessOperations": 21,
      "./setSourceRequest": 22,
      "./shouldRequest": 23
    }],
    20: [function(_dereq_, module, exports) {
      ...
      module.exports = function setInitialArgs(options, seeds, onNext) {
        ...
        var firstSeeds,
            operations;
        var requestOptions = {removeBoundPath: shouldRequest};
        if (shouldRequest) {
          operations = combineOperations(args, toJSONG, 'set', selector, false);
          firstSeeds = [{}];
          setSeedsOrOnNext(operations, true, firstSeeds, false, options.selector);
        ...
        if (isProgressive || isPathValues) {
          var getOps = combineOperations(args, format, 'get', selector, true);
          setSeedsOrOnNext(getOps, seedRequired, seeds, onNext, options.operationSelector);
    ...
    21: [function(_dereq_, module, exports) {
      ...
      function setProcessOperations(model, operations, errorSelector, requestOptions) {
        ...
        if (removeBoundPath && hasBoundPath) {
          model._path = [];
          for (var i = 0,
              opLen = operations.length; i < opLen; i++) {
            var args = operations[i].args;
            for (var j = 0,
                argsLen = args.length; j < argsLen; j++) {
    ...
    22: [function(_dereq_, module, exports) {
      ...
      function setSourceRequest(options, onNext, seeds, combinedResults, requestOptions, cb) {
        var model = options.operationModel;
        var seedRequired = options.format !== toPathValues;
        var requestSeed = requestOptions.requestSeed;
        return model._request.set(requestSeed, getSourceObserver(model, requestSeed.paths, function setSourceRequestCB(err, results) {
          if (err) {
            cb(err);
          }
          model._setJSONGsAsJSON(model, [results], []);
          var operations = combineOperations(options.operationArgs, options.format, 'get');
          setSeedsOrOnNext(operations, seedRequired, seeds, onNext, options.operationSelector);
    ...
    23: [function(_dereq_, module, exports) {
      module.exports = function(model, combinedResults, loopCount) {
        return model._dataSource && (combinedResults.requestedMissingPaths.length > 0 || loopCount === 0);
      };
    }, {}],
    ...
    26: [function(_dereq_, module, exports) {
      ...
      module.exports = function combineOperations(args, format, name, spread, isProgressive) {
        ...
        var seedsOffset = 0;
        return args.reduce(function(groups, argument) {
          var group = groups[groups.length - 1];
          var type = isPathOrPathValue(argument) ? "PathSets" : isJSONG(argument) ? "JSONGs" : "PathMaps";
    ...
    28: [function(_dereq_, module, exports) {
      module.exports = function insertErrors(model, requestedPaths, err) {
        var out = model._setPathSetsAsJSON.apply(null, [model].concat(requestedPaths.reduce(function(acc, r) {
          acc[0].push({
            path: r,
            value: err
          });
    ...
    30: [function(_dereq_, module, exports) {
      module.exports = function isPathOrPathValue(x) {
        return !!(Array.isArray(x)) || (x.hasOwnProperty("path") && x.hasOwnProperty("value"));
      };
    }, {}],
    31: [function(_dereq_, module, exports) {
      ...
      function mergeBoundPath(arg, boundPath) {
        return isJSONG(arg) && mergeBoundPathIntoJSONG(arg, boundPath) || isPathValue(arg) && mergeBoundPathIntoPathValue(arg, boundPath) || mergeBoundPathIntoJSON(arg, boundPath);
      }
      ...
      function mergeBoundPathIntoJSON(arg, boundPath) {
        ...
        if (boundPath.length) {
          newArg = {};
          for (var i = 0,
              len = boundPath.length - 1; i < len; i++) {
            newArg[boundPath[i]] = {};
          }
    ...
    34: [function(_dereq_, module, exports) {
      ...
      function partitionOperations(jsongResponse, seeds, format, onNext) {
        var partitionedOps = [];
        ...
        if (format === 'AsJSON') {
          ...
          opsFromRequestedMissingPaths.forEach(function(op, i) {
            ...
            partitionedOps.push(buildJSONGOperation(format, seed, jsong, op.idx, onNext));
          });
        } else {
    ...
    36: [function(_dereq_, module, exports) {
      module.exports = function processOperations(model, operations, errorSelector, boundPath) {
        return operations.reduce(function(memo, operation) {
          ...
          var seedsOrFunction = operation.isValues ? operation.onNext : operation.seeds;
          var results = jsonGraphOperation(model, operation.args, seedsOrFunction, operation.onNext, errorSelector, boundPath);
          var missing = results.requestedMissingPaths;
          var offset = operation.seedsOffset;
          for (var i = 0,
              len = missing.length; i < len; i++) {
    ...
    40: [function(_dereq_, module, exports) {
      ...
      SetRequest.prototype = {
        ...
        flush: function() {
          ...
          self.pending = true;
          return model._dataSource.set(jsongs[0]).subscribe(function(response) {
      ...
      GetRequest.prototype = {
        ...
        flush: function() {
          ...
          return model._dataSource.get(collapse(optimizedMaps)).subscribe(function(response) {
            incomingValues = response;
          }, function(err) {
            var i = -1;
            var n = observers.length;
          ...
          Rx = {
            ...
            Observable: (function() {
              ...
              Observable.prototype.subscribe = function(n, e, c) {
                return this._subscribe((n != null && typeof n === 'object') ? n : Rx.Observer.create(n, e, c));
              };
              ...
              Observable.prototype.catchException = function(next) {
                ...
                return Observable.create(function(o) {
                  return self.subscribe(function(x) {
                    ...
                    return ((typeof next === 'function') ? next(e) : next).subscribe(o);
                  }, function() {
                    o.onCompleted();
                  });
                });
    ...
    42: [function(_dereq_, module, exports) {
      ...
      ImmediateScheduler.prototype = {schedule: function(action) {
          action();
        }};
    ...
    45: [function(_dereq_, module, exports) {
      ...
      module.exports = function(walk) {
        return function getAsJSON(model, paths, values) {
          ...
          var inputFormat = Array.isArray(paths[0]) || isPathValue(paths[0]) ? 'Paths' : 'JSON';
          var cache = model._cache;
          var boundPath = model._path;
          var currentCachePosition;
          var missingIdx = 0;
          var boundOptimizedPath,
              optimizedPath;
          var i,
              j,
              len,
    ...
    51: [function(_dereq_, module, exports) {
      ...
      function walk(model, root, curr, pathOrJSON, depth, seedOrFunction, positionalInfo, outerResults, optimizedPath, requestedPath, inputFormat, outputFormat, fromReference) {
        if ((!curr || curr && curr.$type) && evaluateNode(model, curr, pathOrJSON, depth, seedOrFunction, requestedPath, optimizedPath, positionalInfo, outerResults, outputFormat, fromReference)) {
          return ;
        } else {
    ...
    53: [function(_dereq_, module, exports) {
      var NOOP = function NOOP() {},
          ...
          __INTERNAL_KEYS = [__CONTAINER, __CONTEXT, __GENERATION, __GENERATION_UPDATED, __INVALIDATED, __KEY, __KEYS, __IS_KEY_SET, __NULL, __SELF, __PARENT, __REF, __REF_INDEX, __REFS_LENGTH, __OFFSET, __ROOT],
          $TYPE = "$type",
          $SIZE = "$size",
          $EXPIRES = "$expires",
          $TIMESTAMP = "$timestamp",
                ...
                if (key != null) {
                  ...
                  if (node !== newNode && (node != null && typeof node === 'object')) {
                    var nodeRefsLength = node[__REFS_LENGTH] || 0,
                        destRefsLength = newNode[__REFS_LENGTH] || 0,
                        i = -1,
                        ref;
                    ...
                    while (depth$2 > -1) {
                      ...
                      var ref$2 = node[$TYPE] === SENTINEL ? node[VALUE] : node,
                          destination;
                      if (ref$2 && Array.isArray(ref$2)) {
                        destination = ref$2[__CONTEXT];
                        if (destination) {
                          var i$2 = (ref$2[__REF_INDEX] || 0) - 1,
                  ...
                  while (node = nodeParent) {
                    ...
                    if ((node[$SIZE] = (node[$SIZE] || 0) - sizeOffset) <= 0 && nodeParent) {
                      var ref$4 = node[$TYPE] === SENTINEL ? node[VALUE] : node,
                          destination$2;
                      if (ref$4 && Array.isArray(ref$4)) {
                        destination$2 = ref$4[__CONTEXT];
                        if (destination$2) {
                          var i$4 = (ref$4[__REF_INDEX] || 0) - 1,
                              n$3 = (destination$2[__REFS_LENGTH] || 0) - 1;
                          while (++i$4 <= n$3) {
                      ...
                      if (node != null && typeof node === 'object') {
                        ...
                        node[__REFS_LENGTH] = void 0;
                        var root$3 = root,
                            head$2 = root$3.__head,
                            tail$2 = root$3.__tail,
                            next$2 = node.__next,
                            prev$2 = node.__prev;
            ...
            if (key != null) {
              ...
              if ((node == null || typeof node !== 'object' || !!nodeType && nodeType !== SENTINEL && !Array.isArray(nodeValue)) && (!mapType && (map != null && typeof map === 'object') && !Array.isArray(mapValue))) {
                ...
                if (node !== nodeValue && (node != null && typeof node === 'object')) {
                  var nodeRefsLength$2 = node[__REFS_LENGTH] || 0,
                      destRefsLength$2 = nodeValue[__REFS_LENGTH] || 0,
                      i$7 = -1,
                      ref$7;
                  ...
                  var invParent$2 = nodeParent,
                      ...
                      childValue$2,
                      isBranch$2,
                      stack$3 = [nodeParent, invKey$2, node],
                      depth$4 = 0;
                  while (depth$4 > -1) {
                    ...
                    var ref$8 = node[$TYPE] === SENTINEL ? node[VALUE] : node,
                        destination$3;
                    if (ref$8 && Array.isArray(ref$8)) {
                      destination$3 = ref$8[__CONTEXT];
                      if (destination$3) {
                        var i$8 = (ref$8[__REF_INDEX] || 0) - 1,
                            n$6 = (destination$3[__REFS_LENGTH] || 0) - 1;
                        while (++i$8 <= n$6) {
                    ...
                    if (node != null && typeof node === 'object') {
                      ...
                      node[__REFS_LENGTH] = void 0;
                      var root$4 = root,
                          head$3 = root$4.__head,
                          tail$3 = root$4.__tail,
                          next$3 = node.__next,
                          prev$3 = node.__prev;
    ...
    58: [function(_dereq_, module, exports) {
      ...
      "../../internal/context": 66,
      "../../internal/ref": 77,
      "../../internal/ref-index": 76,
      "../../internal/refs-length": 78
    }],
    ...
    81: [function(_dereq_, module, exports) {
      ...
      "./invalidate-path-sets-as-json-dense": 82,
      "./invalidate-path-sets-as-json-graph": 83,
      "./invalidate-path-sets-as-json-sparse": 84,
      "./invalidate-path-sets-as-json-values": 85
    }],
    82: [function(_dereq_, module, exports) {
      ...
      function invalidate_path_sets_as_json_dense(model, pathsets, values) {
        ...
        collect(roots.lru, roots.expired, roots.version, roots.root.$size || 0, model._maxSize, model._collectRatio);
        return {
          values: values,
          errors: roots.errors,
          hasValue: true,
      ...
      "../lru/collect": 86,
      "../support/array-clone": 104,
      "../support/array-slice": 105,
      "../support/clone-dense-json": 106,
      "../support/get-valid-key": 116,
      "../support/invalidate-node": 120,
      "../support/is-object": 122,
      "../support/options": 127,
      "../support/update-graph": 137,
      "../walk/walk-path-set": 147
    }],
    83: [function(_dereq_, module, exports) {
      ...
      "../support/array-clone": 104,
      "../support/clone-dense-json": 106,
      "../support/clone-success-paths": 112,
      "../support/get-valid-key": 116,
      "../support/invalidate-node": 120,
      "../support/is-object": 122,
      "../support/options": 127,
      "../support/update-graph": 137,
      "../types/path": 140,
      "../walk/walk-path-set-soft-link": 146
    }],
    ...
    89: [function(_dereq_, module, exports) {
      ...
      "./set-cache": 90,
      "./set-json-graph-as-json-dense": 91,
      "./set-json-graph-as-json-graph": 92,
      "./set-json-graph-as-json-sparse": 93,
      "./set-json-graph-as-json-values": 94,
      "./set-json-sparse-as-json-dense": 95,
      "./set-json-sparse-as-json-graph": 96,
      "./set-json-sparse-as-json-sparse": 97,
      "./set-json-sparse-as-json-values": 98,
      "./set-json-values-as-json-dense": 99,
      "./set-json-values-as-json-graph": 100,
      "./set-json-values-as-json-sparse": 101,
      "./set-json-values-as-json-values": 102
    }],
    90: [function(_dereq_, module, exports) {
      ...
      "../support/array-clone": 104,
      "../support/clone-dense-json": 106,
      "../support/create-branch": 114,
      "../support/get-valid-key": 116,
      "../support/graph-node": 117,
      "../support/inc-generation": 118,
      "../support/is-object": 122,
      "../support/options": 127,
      "../support/replace-node": 130,
      "../support/update-back-refs": 136,
      "../support/update-graph": 137,
      "../support/wrap-node": 138,
      "../types/error": 139,
      "../types/sentinel": 141,
      "../walk/walk-path-map": 145
    }],
    91: [function(_dereq_, module, exports) {
      ...
      "../support/get-valid-key": 116,
      "../support/is-object": 122,
      "../support/merge-node": 125,
      "../support/options": 127,
      "../support/treat-node-as-error": 132,
      "../support/treat-node-as-missing-path-set": 134,
      "../types/path": 140,
      "../walk/walk-path-set-soft-link": 146
    }],
    ...
    95: [function(_dereq_, module, exports) {
      ...
      "../support/replace-node": 130,
      "../support/treat-node-as-error": 132,
      "../support/treat-node-as-missing-path-map": 133,
      "../support/update-back-refs": 136,
      "../support/update-graph": 137,
      "../support/wrap-node": 138,
      "../types/error": 139,
    ...
    96: [function(_dereq_, module, exports) {
      ...
      "../types/path": 140,
      "../types/sentinel": 141,
      "../walk/walk-path-map-soft-link": 144
    }],
    ...
    108: [function(_dereq_, module, exports) {
      ...
      "../walk/walk-path-map-soft-link": 144,
      "./clone-optimized-path": 110,
      "./clone-requested-path": 111,
      "./is-object": 122
    }],
    ...
    121: [function(_dereq_, module, exports) {
      ...
      module.exports = function(roots, node) {
        ...
        if ((expires != null) && (expires != $expires_never) && (expires == $expires_now || expires < now())) {
        ...
        if (type == $path) {
          if (message == null) {
            ...
            if (messageType == $path) {
              ...
              } else if ((is_expired(roots, message) === false) && ((message.$timestamp < node.$timestamp) === false)) {
                value = node.value;
    ...
    144: [function(_dereq_, module, exports) {
      ...
      function walk_path_map(onNode, onEdge, pathmap, keys_stack, depth, roots, parents, nodes, requested, optimized, key, keyset, is_keyset) {
        ...
        for (var i = -1,
          ...
          var is_branch = is_object(pathmap2) && !pathmap2.$type;
          if (is_branch) {
          ...
          if (is_branch) {
            walk_path_map(onNode, onEdge, pathmap2, keys_stack, depth + 1, roots, parents2, nodes2, requested2, optimized2, inner_key, inner_keyset, is_outer_keyset);
          } else {
      ...
      "../internal/prefix": 74,
      "../lru/promote": 87,
      "../support/array-append": 103,
      "../support/array-clone": 104,
      "../support/array-slice": 105,
      "../support/is-expired": 121,
      "../support/is-object": 122,
      "../support/is-primitive": 123,
      "../types/path": 140,
      "./walk-reference": 148
    }],
    ...
    146: [function(_dereq_, module, exports) {
      ...
      function walk_path_set(onNode, onEdge, pathset, depth, roots, parents, nodes, requested, optimized, key, keyset, is_keyset) {
        ...
        while (is_outer_keyset && permute_keyset(outer_key) && (run_once = true) || (run_once = !run_once)) {
          ...
          walk_path_set(onNode, onEdge, pathset, depth + 1, roots, parents2, nodes2, requested2, optimized2, inner_key, inner_keyset, is_outer_keyset);
        }
      }
    }, {
      "../lru/promote": 87,
      ...
      "../support/is-object": 122,
      "../support/is-primitive": 123,
      "../support/keyset-to-key": 124,
      "../support/permute-keyset": 128,
      "../types/path": 140,
      "./walk-reference": 148
    }],
    ...
    153: [function(_dereq_, module, exports) {
      ...
      Promise.prototype.then = function(onFulfilled, onRejected) {
        if (this.constructor !== Promise)
          return this._10(onFulfilled, onRejected);
        var res = new Promise(noop);
      ...
      Promise.prototype._82 = function(newValue) {
        ...
        if (newValue && (typeof newValue === 'object' || typeof newValue === 'function')) {
          ...
          if (then === this.then && newValue instanceof Promise && newValue._24 === this._24) {
            this._71 = 3;
            this._18 = newValue;
    ...
    157: [function(_dereq_, module, exports) {
      ...
      "./core.js": 153,
      "./done.js": 154,
      "./es6-extensions.js": 155,
      "./finally.js": 156,
      "./node-extensions.js": 158
    }],
