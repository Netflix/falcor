...
Each [JSON Graph](http://netflix.github.io/falcor/documentation/jsongraph.html) operation is executed asynchronously, resulting in an Observable of JSONGraphEnvelope. Unlike the [Model](http://netflix.github.io/falcor/documentation/model.html), DataSources do _not_ support [Path Syntax](http://netflix.github.io/falcor/documentation/paths.html#path-syntax-strings). DataSources can only accept [Path Arrays and PathSet Arrays](http://netflix.github.io/falcor/documentation/paths.html#path).
...
var dataSource = new Router([
    {
        ...
        call: function(callPath, args) {
            ...
            if (parseInt(titleId, 10).toString() !== titleId.toString()) throw new Error('invalid input');

            return myListService.addTitle(titleId).then(function(length) {
                return [
                    {
...
_Note_: Data Source must return either the new altered values as part of
