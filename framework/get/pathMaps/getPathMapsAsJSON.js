function getPathMapsAsJSON(model, pathMaps, values, errorSelector, boundPath) {
    ...
    curried initMapStack     = initPathMapStack(pathMapStack),
            ...
            onJSONMiss       = onPathMapMiss(boundPath, boundLength, requestedPath, optimizedPath, requestedMissingPaths, optimizedMissingPaths, pathMapStack),
