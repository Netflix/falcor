...
describe("Values", function() {
    ...
    it(
        "should get a value of type atom when in materialized mode.",
        function() {
            getCoreRunner({
                ...
                cache: {
                    ...
                    paths: [["videos", { to: 1 }, "title"]]
                }
            });
        }
    );
    it(
        "should get a value through references with complex pathSet.",
        function() {
            getCoreRunner({
    ...
    it(
        "should allow for multiple arguments with different length paths.",
        function() {
            var lolomo0 = {
                length: 1337
            };
            lolomo0.$_path = ["lolomo", "0"];
            var lolomo = {
                length: 1,
                0: lolomo0
            };
            ...
            getCoreRunner({
                input: [["lolomo", 0, "length"], ["lolomo", "length"]],
                output: output,
                cache: {
                    lolomo: {
                        length: 1,
    ...
    it(
        "should allow for a null at the end to get a value behind a reference.",
        function() {
            getCoreRunner({
                input: [["lolomo", null]],
                output: {
    ...
    it(
        "should get JSONGraph for a single value out, !modelCreated",
        function() {
            getCoreRunner({
                input: [["videos", 0, "title"]],
                isJSONG: true,
    ...
    it(
        "should allow for multiple arguments with different length paths as JSONGraph.",
        function() {
            getCoreRunner({
                input: [["lolomo", 0, "length"], ["lolomo", "length"]],
                output: {
                    ...
                    paths: [["lolomo", 0, "length"], ["lolomo", "length"]]
                },
                isJSONG: true,
                cache: {
                    lolomo: {
    ...
    it(
        "should get JSONGraph through references with complex pathSet.",
        function() {
            getCoreRunner({
                input: [["lolomo", { to: 1 }, { to: 1 }, "item", "title"]],
                isJSONG: true,
                output: {
                    jsonGraph: _.merge(
                        cacheGenerator(0, 2),
                        cacheGenerator(10, 2, undefined, false)
                    ),
                    paths: [
    ...
    it(
        "should get JSONGraph allow for a null at the end to get a value behind a reference.",
        function() {
            getCoreRunner({
